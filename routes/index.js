...
router.get('/', function(req, res, next) {
  ...
  Product.find((err, docs) => {
    ...
    res.render('shop/index', { title: 'Top Shelf Whisky', products: productChunks, successMsg: successMsg, noMessages: !successMsg });
  });
});
...
router.get('/shop/:region', (req, res, next) => {
  ...
  Product.find({category: type}, (err, docs) => {
    ...
    if (docs.length === 0) {
      return res.render('shop/'+type, { title: "No "+type+" whiskies in stock at this time"});
    }
...
router.get('/home', (req, res, next) => {
  res.render('landing/home', { title: "Top Shelf Whisky", layout: 'homelayout.hbs' });
})
